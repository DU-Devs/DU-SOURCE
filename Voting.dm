...
Voting/var
	Yes=0;No=0
mob/proc/Ignore(Vote_Initiator) if(ignore_votes&&Vote_Initiator!="Tens of DU") return 1
...
obj/Voting
	...
	verb/Voting()
		...
		if(!can_admin_vote) Options.Remove("Vote Head Admin")
		...
		if(server_mode=="PVP") Options-="Vote for President"
